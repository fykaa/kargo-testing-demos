...
const (
	...
	// stateKeyCommitMessage is the key used to store the commit message in the shared State.
	stateKeyCommitMessage = "commitMessage"
)
...
func (g *gitCommitter) run(
	...
	return promotion.StepResult{
		...
		Output: map[string]any{
			...
			stateKeyCommitMessage: cfg.Message,
		},
	}, nil
}
